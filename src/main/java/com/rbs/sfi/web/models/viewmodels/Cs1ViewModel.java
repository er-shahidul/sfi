...
public class Cs1ViewModel extends BaseViewModel {
    ...
    public void setPrimaryOperMillsYardsOtherCountries(Set<SfiPpFormOtherCountryViewModel> primaryOperMillsYardsOtherCountries) {
    ...
    public void setSecondaryOperMillsYardsOtherCountries(Set<SfiPpFormOtherCountryViewModel> secondaryOperMillsYardsOtherCountries) {
